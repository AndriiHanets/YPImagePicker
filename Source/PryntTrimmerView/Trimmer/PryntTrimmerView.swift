...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    private var rConstraint: NSLayoutConstraint?
    ...
    private func setupTrimmerView() {
        ...
        lConstraint = trimView.leftAnchor.constraint(equalTo: leftAnchor)
        rConstraint = trimView.rightAnchor.constraint(equalTo: rightAnchor)
    ...
    @objc func handlePanGesture(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .began:
            if isLeftGesture {
                currentLeftConstraint = lConstraint!.constant
                leftDurationView.set(visable: true)
            } else {
                currentRightConstraint = rConstraint!.constant
                rightDurationView.set(visable: true)
            }
    ...
    private func updateLeftConstraint(with translation: CGPoint) {
        ...
        lConstraint?.constant = newConstraint
    }
    ...
    private func updateRightConstraint(with translation: CGPoint) {
        ...
        rConstraint?.constant = newConstraint
    }
