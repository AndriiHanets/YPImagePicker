...
class AssetVideoScrollView: UIScrollView {
    ...
    private func setupSubviews() {
        ...
        wConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 1.0)
    ...
    private func setContentSize(for asset: AVAsset) -> CGSize {
        ...
        wConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: contentWidthFactor)
        wConstraint?.isActive = true
        layoutIfNeeded()
